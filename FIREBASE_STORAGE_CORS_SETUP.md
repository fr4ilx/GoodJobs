...
## Problem
Your app is getting CORS errors when trying to fetch PDF files from Firebase Storage. This happens because Firebase Storage doesn't allow requests from `localhost:3000` by default.
